...
public class MusicMgr : BaseManager<MusicMgr>
{
    ...
    //音效依附对象
    private GameObject soundObj = null;//主要对象，只有一个
    private GameObject nameObj = null;//识别对象，用于管理
    ...
    public void PlaySound(string name, bool isLoop, float soundValue, UnityAction<AudioSource> callBack = null)
    {
        ...
        ResMgr.GetInstance().LoadAsync<AudioClip>($"Sound/{name}", (clip) =>
        {
            ...
            nameObj = new GameObject(name);
            AudioSource source = nameObj.AddComponent<AudioSource>();
            nameObj.transform.parent = soundObj.transform;
